...
export default function AccessDenied() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[93.3vh] py-2 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500">
      <div className="p-5 bg-white shadow-lg rounded-lg ">
        ...
        <div className="text-center p-5">
          ...
          <Link legacyBehavior href="/">
            <a className="inline-block mt-4 px-6 py-2 text-sm font-medium leading-6 text-center text-white uppercase transition bg-indigo-600 rounded-full shadow-sm ripple hover:shadow-lg hover:bg-indigo-700 focus:outline-hidden">
              Go back to Home
            </a>
          </Link>
        </div>
